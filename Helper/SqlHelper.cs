...
namespace 选课系统
{
    ...
    //    static SqlHelper()
    //    {
    //        var conn = System.Configuration.ConfigurationManager.ConnectionStrings["CourseConStr"];
    //        if (conn!=null)
    //        {
    ...
    //    /// <param name="reader">当前指向的reader</param>
    //    /// <returns>实体对象</returns>
    //    public static TEntity SqlReaderMapEntity<TEntity>(SqlDataReader reader) where TEntity : class, new()
    //    {
    //        try
    //        {
    //            // 获取所有属性
    ...
    //    #region SqlDataAdapter +static DataSet ExecuteDataAdapter(string cmdText)
    //    /// <summary>
    //    /// 执行一个查询的T-SQL语句, 返回一个离线数据集DataSet
    //    /// </summary>
    //    /// <param name="cmdText">要执行的T-SQL语句</param>
    //    /// <returns>SqlDataAdapter</returns>
    //    public static SqlDataAdapter ExecuteDataAdapter(string cmdText)
    //    {
